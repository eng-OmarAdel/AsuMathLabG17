...
void inputCheckerTrigonometry(string input) // this is just a model for sin strings
{
	...
	if ((input.find("sin(") != -1) && (input[input.find("sin(") - 1] != 'a'))
	{
		//sinOperation holds what is inside the sin()
		...
		if (index != -1)
		{
			...
			memory.p[index].setElement(0, 0, sin(StringToDouble(sinOperation)));
			memory.p[index].print();
		}
		...
		else
		{
			...
			memory.p[memory_arrow].setElement(0, 0, sin(StringToDouble(sinOperation)));
			memory.p[memory_arrow].print();
			memory_arrow++;
		}
	}

	else if ((input.find("sind(") != -1) && (input[input.find("sind(") - 1] != 'a'))
	{
		//sinOperation holds what is inside the sin()
		string sinOperation = input.substr((input.find("sind(") + 5), (input.find(")") - (input.find("sind(") + 5)));
		...
		if (index != -1)
		{
			...
			//asg=(index1==index || index2==index);
			memory.p[index].initialling(1, 1);
			memory.p[index].setElement(0, 0, sin((PI / 180)*(StringToDouble(sinOperation))));
			memory.p[index].print();
		}
		...
		else
		{
			memory.creat(matrix_name);
			memory.p[memory_arrow].initialling(1, 1);
			memory.p[memory_arrow].setElement(0, 0, sin((PI / 180)*(StringToDouble(sinOperation))));
			memory.p[memory_arrow].print();
			memory_arrow++;
		}
	}
	else if (input.find("asin(") != -1)
	{
		//sinOperation holds what is inside the sin()
		string sinOperation = input.substr((input.find("asin(") + 5), (input.find(")") - (input.find("asin(") + 5)));
		...
		if (index != -1)
		{
			...
			//asg=(index1==index || index2==index);
			memory.p[index].initialling(1, 1);
			memory.p[index].setElement(0, 0, asin(StringToDouble(sinOperation)));
			memory.p[index].print();
		}
		...
		else
		{
			memory.creat(matrix_name);
			memory.p[memory_arrow].initialling(1, 1);
			memory.p[memory_arrow].setElement(0, 0, asin(StringToDouble(sinOperation)));
			memory.p[memory_arrow].print();
			memory_arrow++;
		}
	}
	else if (input.find("asind(") != -1)
	{
		//sinOperation holds what is inside the sin()
		string sinOperation = input.substr((input.find("asind(") + 6), (input.find(")") - (input.find("asind(") + 6)));
		...
		if (index != -1)
		{
			...
			//asg=(index1==index || index2==index);
			memory.p[index].initialling(1, 1);
			memory.p[index].setElement(0, 0, ((180.0 / PI)*asin(StringToDouble(sinOperation))));
			memory.p[index].print();
		}
		...
		else
		{
			memory.creat(matrix_name);
			memory.p[memory_arrow].initialling(1, 1);
			memory.p[memory_arrow].setElement(0, 0, ((180.0 / PI)*asin(StringToDouble(sinOperation))));
			memory.p[memory_arrow].print();
			memory_arrow++;
		}
	}
	else if ((input.find("sinh(") != -1) && (input[input.find("sinh(") - 1] != 'a'))
	{
		//sinOperation holds what is inside the sin()
		string sinOperation = input.substr((input.find("sinh(") + 5), (input.find(")") - (input.find("sinh(") + 5)));
		...
		if (index != -1)
		{
			...
			//asg=(index1==index || index2==index);
			memory.p[index].initialling(1, 1);
			memory.p[index].setElement(0, 0, sinh(StringToDouble(sinOperation)));
			memory.p[index].print();
		}
		else
		{
			memory.creat(matrix_name);
			memory.p[memory_arrow].initialling(1, 1);
			memory.p[memory_arrow].setElement(0, 0, sinh(StringToDouble(sinOperation)));
			memory.p[memory_arrow].print();
			memory_arrow++;
		}

	}
	else if (input.find("asinh(") != -1)
	{
		//sinOperation holds what is inside the sin()
		string sinOperation = input.substr((input.find("asinh(") + 6), (input.find(")") - (input.find("asinh(") + 6)));
		...
		if (index != -1)
		{
			...
			//asg=(index1==index || index2==index);
			memory.p[index].initialling(1, 1);
			memory.p[index].setElement(0, 0, (asinh(StringToDouble(sinOperation))));
			memory.p[index].print();
		}
		...
		else
		{
			memory.creat(matrix_name);
			memory.p[memory_arrow].initialling(1, 1);
			memory.p[memory_arrow].setElement(0, 0, (asinh(StringToDouble(sinOperation))));
			memory.p[memory_arrow].print();
			memory_arrow++;
